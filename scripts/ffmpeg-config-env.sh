...
# export COMMON_FF_CFG_FLAGS="$COMMON_FF_CFG_FLAGS --enable-bsfs=h264_mp4toannexb"
# export COMMON_FF_CFG_FLAGS="$COMMON_FF_CFG_FLAGS --enable-bsfs=hevc_metadata"
# export COMMON_FF_CFG_FLAGS="$COMMON_FF_CFG_FLAGS --enable-bsfs=hevc_mp4toannexb"
# export COMMON_FF_CFG_FLAGS="$COMMON_FF_CFG_FLAGS --enable-bsfs=trace_headers"
...
export FFMPEG_BUILD_CONFIGURATION_FLAGS="$FFMPEG_BUILD_CONFIGURATION_FLAGS $COMMON_FF_CFG_FLAGS"